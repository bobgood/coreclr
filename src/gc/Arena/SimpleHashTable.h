...
#pragma warning(disable:4250)
	...
	public:
		...
		bool IEnumeratorBase::MoveNext(void)
		{
			return SimpleHashSetBase::EnumeratorObjectBase::MoveNext();
		}
		void IEnumeratorBase::Reset(void)
		{
			SimpleHashSetBase::EnumeratorObjectBase::Reset();
		}
	private:
...
T& SimpleHashTable<T, ThreadingPolicy>::operator[](unsigned __int64 key)
{
	...
	for (;;)
	{
		...
		{
			assert("SimpleHashTable overflow.");
		}
	}
}
